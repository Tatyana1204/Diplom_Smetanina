...
<main>
	<!-- Уместить все на одной странице или на двух? -->
		...
		<div class="row">
			<div class="col-3 col-lg-3 col-xl-3 ">
				<div class='form-container'>
					...
					<h4 style="margin-bottom: 3vh;">Добавить категорию</h4>
					<form id="addCategoryForm" action="dashboard/addCategory" method="post">
						<div class="mb-3">
						...
						<ul class="list-group list-group-flush goods-list margin-top-15">
							<?php foreach ($this->categories as $category) { ?>
								...
								<li class="list-group-item">
									<div class="product-card" id="<?php echo $category->id; ?>">
								...
								<li class="list-group-item update-form-container display-none">
									<div class="update-form">
										<form id="<?php echo $category->id; ?>" class="updateCategoryForm" action="dashboard/addCategory" method="post">
											<div class="mb-3">
												<input type="text" name="id" class="form-control" value="<?php echo $category->id; ?>" readonly>
											</div>
											<div class="mb-3">
												<input type="text" name="title" class="form-control" value="<?php echo $category->title; ?>" placeholder="название">
											</div>
											<div class="mb-3">
								...
								<li class="list-group-item delete-form-container display-none">
									<div class="delete-form">
										<form id="<?php echo $category->id; ?>" class="deleteCategoryForm" action="dashboard/addProduct" method="post">
											<div class="mb-3">
												<input type="text" name="id" class="form-control" value="<?php echo $category->id; ?>" readonly>
											</div>
